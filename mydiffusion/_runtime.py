...
MYDIFFUSION_DATA_DIR_ENV_VAR = "MYDIFFUSION_DATA_DIR"
MYDIFFUSION_OUTPUTS_DIR_ENV_VAR = "MYDIFFUSION_OUTPUTS_DIR"
MYDIFFUSION_REPORTS_DIR_ENV_VAR = "MYDIFFUSION_REPORTS_DIR"
MIMICGEN_TASKS = (
    "mug_cleanup_d0",
    "coffee_d0",
...
def add_repo_paths() -> None:
    for path in (REPO_ROOT, DIFFUSION_POLICY_REPO_ROOT):
        path_str = str(path)
...
def raw_dataset_root() -> Path:
    data_root = _path_from_env(MYDIFFUSION_DATA_DIR_ENV_VAR, MYDIFFUSION_ROOT / "data")
...
def reports_dir() -> Path:
    return _path_from_env(MYDIFFUSION_REPORTS_DIR_ENV_VAR, MYDIFFUSION_ROOT / "reports")


def outputs_dir() -> Path:
    return _path_from_env(MYDIFFUSION_OUTPUTS_DIR_ENV_VAR, MYDIFFUSION_ROOT / "outputs")
...
def task_config_yaml(
    ...
    dataset_path = (
        "${oc.env:"
        f"{MYDIFFUSION_DATA_DIR_ENV_VAR},mydiffusion/data"
