...
RUNNER="${ROOT_DIR}/mydiffusion_D1/scripts/run_baseline.py"
DEVICE="${MYDIFFUSION_D1_DEVICE:-cuda:0}"

TASKS=(
  "mug_cleanup_d1_lowdim_abs"
  "coffee_d1_lowdim_abs"
  "three_piece_assembly_d1_lowdim_abs"
)
